...
class OracleNativeModule(
    ...
    init {
        ...
        center.addView(TextView(context).apply { text="BUILD 494";textSize=8f;typeface=Typeface.DEFAULT_BOLD;letterSpacing=.10f;setTextColor(Color.rgb(115,150,190));gravity=Gravity.CENTER;includeFontPadding=true })
