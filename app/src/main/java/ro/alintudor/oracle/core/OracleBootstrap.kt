...
object OracleBootstrap {
    ...
    fun ensure(repository: OracleRepository) {
        ...
        repository.saveHistory(listOf(
            OracleHistoryPoint("CRM", 1787841364000L, 252.05, 1008.20, 13.44),
            OracleHistoryPoint("MELI", 1787664732000L, 1930.75, 1930.75, -6.45),
            OracleHistoryPoint("HOOD", 1787594825000L, 109.76, 1097.60, 24.45)
        ))
