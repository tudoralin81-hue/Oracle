...
# Serialize local refreshes so two simultaneous reopen/refresh operations cannot
# both read the old Growth snapshot and save different rankings.
...
# This is the next controlled application build. Analysis remains on its B514 UI label.
...
# Growth footer only. Do not modify OracleAnalysisModules.kt.
